      ...
      <div class="modal-body">
        ...
        <form class="forms-sample" action="./DB/<?= strtolower($heading) ?>.process.php" method="POST"
          ...
          <div class="form-group">
            ...
            <input type="password" class="form-control" name="us_passwordHash" id="us_passwordHash"
              placeholder="<?= $heading ?> Password">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="date" class="form-control" name="us_DOB" id="us_DOB"
              placeholder="<?= $heading ?> Date of Birth">
          </div>
          <div class="form-group">
            <label for="us_nationality">Nationality</label>
            <input type="text" class="form-control" name="us_nationality" id="us_nationality"
              placeholder="<?= $heading ?> Nationality">
          </div>
