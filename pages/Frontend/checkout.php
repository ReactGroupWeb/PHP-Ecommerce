                                                                 ...
                                                                 <div class="wrap-address-billing">
                                                                      ...
                                                                      <div class="row">
                                                                           <div class="col-6 mb-3">
                                                                                ...
                                                                                <input type="text" name="card-no" class="form-control py-2" value="" required placeholder="Card Number" >
                                                                           </div>

                                                                           <div class="col-6 mb-3">
                                                                                <label class="mb-2 fw-bold text-capitalize" for="expiry-month">Expiry Month</label>
                                                                                <input type="text" name="expiry-month" class="form-control py-2" value="" required placeholder="MM">
                                                                           </div>

                                                                           <div class="col-6 mb-3">
                                                                                <label class="mb-2 fw-bold text-capitalize" for="expiry-year">Expiry Year</label>
                                                                                <input type="text" name="expiry-year" class="form-control py-2" value="" required placeholder="YYYY">
                                                                           </div>

                                                                           <div class="col-6 mb-3">
                                                                                <label class="mb-2 fw-bold text-capitalize" for="cvc">CVC</label>
                                                                                <input type="password" name="cvc" class="form-control py-2" value="" required placeholder="CVC">
                                                                           </div>
                                                                      </div>
